...
\item Analysis: Case study, glioma analysis
\item Conclusion
\end{enumerate}
...
\vspace*{-0.5cm}
	\begin{figure}
		\centering
	\includegraphics[width=1.0\textwidth]{intro/breast.jpg}{\tiny{\\ Kristensen VN, et al. Principles and methods of integrative genomic analyses in cancer. Nature Reviews Cancer (2014)}}
	\end{figure}
	\pdfnote{With the improvement of technology we were able to acquire enormous quantities of molecular data}
	\pdfnote{emergence of 'systems biology' — understanding of the interplay within and between different}
	\pdfnote{layers of genomic structures can one attempt to  understand phenotypic traits}
\end{frame}
...
\vspace{-0.4cm}
	\begin{figure}
		\centering
	\includegraphics[width=0.8\linewidth,height=0.8\textheight]{intro/data_integration.jpg}{\tiny{\\ Ritchie MD, et al. Methods of integrating data to uncover genotype-phenotype interactions. Nature Reviews Genetics (2015)}}
	\end{figure}
	\pdfnote{This layers of genomic structures creates a network of interaction}
\end{frame}
...
\begin{figure}
 \centering
 \includegraphics[width=1.05\linewidth]{images/DNAmethylation/5side2}{\tiny{\\Source: Jones PA, et al. Nature Reviews Genetics (2002) doi:10.1038/nrg816}}
\end{figure}
\pdfnote{DNA methylation is a process by which methyl groups are added to the DNA molecule.}
\pdfnote{In mammals DNA met. is almost exclusively found in CpG dinucleotides}
