...
\vspace*{-0.5cm}
	...
	\end{figure}
	\pdfnote{ With the improvement of technology we were ableto acquire enormous quantities of molecular data, which has led to the emergence of 'systems biology' — understanding of the interplay within and between different layers of genomic structures can one attempt to  understand phenotypic traits }
\end{frame}
