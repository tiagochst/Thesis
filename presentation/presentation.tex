...
\begin{frame}{Step 5: TF ranking plot}
 \begin{figure}
  \centering
  \includegraphics[width=1.0\linewidth]{ELMER/FOS_TF.png}
 \end{figure}
\end{frame}
...
\begin{frame}{Step 5: Results}
 \begin{table}[h!]
  \centering
  \tiny
  \csvautobooktabular[respect underscore]{tables/getTF.hypo.significant.TFs.with.motif.summary.csv}
  \label{tab:get.tf}
 \end{table}
 %\tiny\csvautotabular[respect all]{getTF.hypo.significant.TFs.with.motif.summary.csv}
\end{frame}
