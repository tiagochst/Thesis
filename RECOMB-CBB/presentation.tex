...
\titlegraphic{
\includegraphics[height=.10\textheight]{cedars}
\hspace{1cm}
...
%\date{\small{\jobname}}
%\date{\today}
\author[Tiago Chedraoui Silva]{\small {Tiago C Silva, Simon G Coetzee, Nicole Gull, Lijing Yao, Dennis J Hazelett, Houtan Noushmehr, De-Chen Lin, Benjamin P Berman}} % auteur
...
%\item Introduction
%\item Methods: ELMER algorithm
%\item Case of study: TCGA-BRCA
%\item Conclusion
%\end{enumerate}
...
\begin{frame}{ELMER modes - Dealing with different molecular subtypes}
 \vspace*{0.5cm}
\begin{figure}
 \centering
 \includegraphics[width=1.0\linewidth]{ELMER/mode_subtype.png}
\end{figure}
\end{frame}
...
\begin{frame}{Step 4:  TF motifs source}
 ...
 \begin{figure}
 \hspace*{-0.4cm}
  \includegraphics[width=1.1\linewidth]{ELMER/hocomoco_new.png}{\tiny{\\\vspace{-0.3cm}HOCOMOCO v11 (http://hocomoco11.autosome.ru/human/mono?full=true), Accessed: 26-12-2017}}
 \end{figure}
\end{frame}
...
\begin{frame}{Step 4: Motif enrichment analysis}
  ...
  \begin{figure}
  \hspace*{-1cm} 
  \includegraphics[width=0.95\linewidth]{ELMER/OR_lumb_basal.pdf}
 \end{figure}
\end{frame}
...
\begin{frame}{TFs ranking for the \textit{FOXA2} motif}
 \vspace*{-0.4cm}
 \begin{figure}
  \centering
...
\begin{frame}{TFs ranking for the \textit{FOXA2} motif}
 ...
 \begin{figure}
  \centering
  \includegraphics[width=1.1\linewidth]{ELMER/avgDNAmet_FOXA2}
   \end{figure}
\end{frame}
...
\vspace*{-0.2cm}
 \begin{figure}[ht!]
  \centering
\includegraphics[width=0.7\textwidth]{ELMER/tbl.png}
 \end{figure}
\end{frame}
...
%Number of TF motifs      & 145    & 771  (HOCOMOCO v11 database)    \\\midrule
...
\begin{frame}{Acknowledgments}
 ...
 \begin{columns}[T]
  \begin{column}{0.5\textwidth}
   \begin{block}{Cedars-Sinai Hospital Center}
    \begin{itemize}
     \item Benjamin P. Berman
     \item Simon Coetzee
...
\vspace{0.2cm}
 \begin{columns}[T]
  \begin{column}{0.5\textwidth}
   \begin{block}{University of S\~ao Paulo}
    \begin{itemize}
  ...
  \begin{column}{0.5\textwidth}
   \vspace{0.3cm}
   \includegraphics[width=0.35\linewidth]{logo/usp.png}
  \end{column}
 \end{columns}
