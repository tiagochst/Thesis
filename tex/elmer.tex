...
\lstinputlisting[language=R, frame = none, label = {lst:distal},caption = "Step 2: Selection of probes within biofeatures"]{codes/distal_probes.R}
...
\lstinputlisting[language=R, frame = none, label = {lst:mae},caption = "Step 3: Create MultiAssayExperiment"]{codes/mae.R}
...
%\begin{minipage}{\linewidth}
\lstinputlisting[language=R, frame = none, label = {lst:getpair}, caption = "Step 5: Identify putative target genes for differentially methylated distal probes"]{codes/getpair.R}
%\end{minipage}
...
\caption{\label{fig:funcivar} Enrichment of paired probes and chromatin states of encode cells.
...
\csvautobooktabular[respect underscore,
					before reading=\sisetup{round-mode=places,round-precision=2},
                    filter expr={test{\ifnumless{\thecsvinputline}{20}}}]{tables/funcivarcode.csv}
\caption {Chromatin states abbreviation}
\label{tab:funcivarcode}
\end{table}
...
%\begin{minipage}{\linewidth}
%\lstinputlisting[language=R, frame = none,label = "motif",caption = "Step 6: Motif enrichment analysis on the selected probes"]{codes/motif.R}
%\end{minipage}
...
%\lstinputlisting[language=R, frame = none,label = "tf",caption = "Step 7: Identify regulatory Transcript Factors"]{codes/tf.R}
