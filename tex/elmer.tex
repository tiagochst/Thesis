...
To limit ELMER to the analysis of distal elements, probes located in regions of $\pm2 kb$ around \sigla{TSSs}{transcription start sites} were removed.
...
%\lstinputlisting[language=R, label = {lst:distal},caption = "Step 2: Selection of probes within biofeatures"]{codes/distal_probes.R}
...
%\lstinputlisting[language=R, label = {lst:mae},caption = "Step 3: Create MultiAssayExperiment"]{codes/mae.R}
...
%\lstinputlisting[language=R, label = {lst:verifymae},caption = "Verifying MultiAssayExperiment"]{codes/mae_verify.R}
...
%\lstinputlisting[language=R, label = {lst:diffMeth},caption = "Identify significantly different DNA methylation probes in tumor and normal samples"]{codes/diffMeth.R}
%\end{minipage}
...
%\begin{minipage}{\linewidth}
%\lstinputlisting[language=R, label = {lst:getpair}, caption = "Step 5: Identify putative target genes for differentially methylated distal probes"]{codes/getpair.R}
%\end{minipage}
...
\caption {First three rows of  getPair.hypo.pairs.significant.csv file.}
\label{tab:get.pair}
\end{table}
...
%\begin{minipage}{\linewidth}
%\lstinputlisting[language=R,firstline=5,lastline=13,label = {lst:plotpair},caption = "Schematic plot to visualize gene-probe pairs"]{codes/plotpair.R}
%\end{minipage}
...
% \begin{minipage}{\linewidth}
% \lstinputlisting[language=R,label = {lst:scatterplot},caption = "Scatter plot to visualize correlation between gene expression and DNA methylation levels at probe"]{codes/scatterplot.R}
% \end{minipage}
...
%\begin{minipage}{\linewidth}
%\lstinputlisting[language=R,basicstyle=\ttfamily\scriptsize]{codes/enhancer.R}
%\end{minipage}
%\begin{minipage}{\linewidth}
%\lstinputlisting[language=R,basicstyle=\ttfamily\scriptsize,label = {lst:funcivar},caption = "Chromatin state annotation for probe regions"]{codes/funcivar.R}
%\end{minipage}
...
%\begin{minipage}{\linewidth}
%\lstinputlisting[language=R,label = "motif",caption = "Step 6: Motif enrichment analysis on the selected probes"]{codes/motif.R}
%\end{minipage}
...
%\lstinputlisting[language=R,label = "tf",caption = "Step 7: Identify regulatory Transcript Factors"]{codes/tf.R}
