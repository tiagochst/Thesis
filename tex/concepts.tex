...
\begin{description}
  ...
  \end{figure}
  \item [\sigla{SE}{SummarizedExperiment}:]  a matrix-like container where rows represent ranges of interest (as a GRanges or GRangesList object) and columns represent samples (with sample data summarized as a DataFrame). It can contains one or more assays, each represented by a matrix-like object of numeric or other mode. An example of GRanges object is shown in Figure \ref{fig:SE}.
  \begin{figure}[ht!]
  \centering
