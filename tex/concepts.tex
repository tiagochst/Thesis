...
% Falar sobre barcodes
% representação de dados geneticos e epigeneticos
% dados brutos vs processados
...
\begin{description}
  \item [GenomicRanges (GRanges):] This data strucute was created to representation and manipulate genomic intervals and variables defined along a genome
  GRanges is a vector of genomic locations, which are composed by the sequence names (chr1, chr2), the sequence range (start and end) and the strand information, and associated annotations (metadata) \cite{lawrence2013software}.
