...
Data integration can be divided into two main categories:
single-platform integration and cross-platform integration.
The first category related to the integration of data with information on one type of variation, such as the integration of expression data generated in
different studies, while the second integrates data with information on different types of variation, such as integrated analysis of expression and methylation \cite{thingholm2016strategies}.
