...
To identify each of these samples, each database use an unique identifier, which is able
...
The barcode identifies if a samples is a primary solid tumor sample or a normal tissue samples,
but if there was a mistake in the metadata and the sample which was normal was set to a tumor samples,
...
through either anm agglomerative ("bottom-up") or a divisive ("top-down") procedures.
