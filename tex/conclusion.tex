...
\begin{itemize}
	\item 	The main contributions to the were the structuring of the package according to the standards of the Bioconductor project, the creation of all data functions (query, download and prepare) and some  function for analysis and visualization (survival analysis, DNA methylation analysis and plots and integration of DNA methylation and gene expression and visualization in a starburst plot function), the creation of unitary tests, the creation of the documentation for the functions listed above, and the creation of two use case.
\end{itemize}
