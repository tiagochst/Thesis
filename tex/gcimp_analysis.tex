...
\caption[G-CIMP analysis: Volcano plot]{G-CIMP analysis: DNA methylation  Volcano plot). Difference of DNA methylation ($\min\Delta\overline{\beta}$) versus significance $-log_{10}(FDR corrected P-values)$.}
\end{figure}
\label{fig:gcimpvolcano}
\end{center}
...
\caption[G-CIMP analysis: Heatmap of paired probes and distal genes]{G-CIMP analysis:
Heatmap of paired probes and distal genes.}
\end{figure}
\label{fig:gcimpheatmap}
\end{center}
