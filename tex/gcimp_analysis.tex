...
\caption[G-CIMP analysis: Odds Ratio plot]{Motif enrichment analysis: Odds Ratio (x axis) for the selected motifs with OR above 1.5. The range shows the 95\% confidence interval for each Odds Ratio.}
\end{figure}
\label{tab:or}
\end{center}
