...
\node [labelbiomart, below of=tss,yshift = 0.5cm] (biomart) {};
\node [dataaux, below of=tss,yshift = -0.4cm] (probesmetadata) {Probes metadata};


\node (funciVar) [function, below of=func6, xshift = 3cm, yshift = -1.4cm] {enrich.segments};
...
\draw [arrow,dashed,draw=orange] (biomart.north) -- (tss.south);
...
%------------------------------ TCGAbiolinks
\node (GDCprepare) [function, right of = func1, yshift =-2.4cm,xshift =8.2cm] {\textit{GDCprepare}};
...
\node (TCGAanalyzeEAcomplete) [function, right of = func4,yshift =-1.0cm,xshift =7.8cm] {\textit{TCGAanalyze\_EAcomplete}};
\node (TCGAanalyzePathview) [function, right of = func4,yshift =-1.9cm,xshift =7.8cm] {\textit{TCGAanalyze\_Pathview}};
\node (TCGAvisualizeoncoprint) [function, right of = func4,yshift =-2.8cm,xshift =7.8cm] {\textit{TCGAvisualize\_oncoprint}};
...
\node [draw,
       minimum height=360pt,
       minimum width=160pt,
       yshift = -0.85cm,
       fit=(TCGAanalyzeEAcomplete)(GDCquery)(TCGAvisualizeoncoprint)(clinicalinfo)(subtypeinfo)](container10){};
...
\draw [draw,dashed] (gdc.185) |- (GDCdownload.west);
\draw [arrow,dashed] (gdc.185) |- (mafinfo.west);
\draw [arrow,dashed] (gdc.185) |- (clinicalinfo.west) ;
\draw [arrow,dashed] (gdc.185) |- (molecularinfo.west) ;
}
...
\node [labelencode, right of = statehub,xshift=-7.80cm,yshift=-0.75cm] (encode) {};
\node [labelroadmap, below of = encode,xshift=-0.1cm,yshift=0.5cm] (roadmap) {};
\node [labelblueprint, above of = encode,yshift=-0.6cm,xshift=-0.1cm] (blueprint) {};
%\draw [latex'-latex',double] (encode.180) --  (containerFunciVar.0);
\draw [double,->] (encode.0) -- ++(1.4,0) |-  (statehub.180);
